                ...
                if (isset($desc['buttons']) && !empty($desc['buttons'])) {
                    ...
                    if (!empty($buttons)) {
                        foreach ($buttons as $button) {
                            ...
                            $btn_text .= '<button disabled onclick="window.location.href = ' . $button_url . '" class="btn btn-gradient-dark mb-4 mr-2"><span>' . $button['text'] . '</span></button>&nbsp';
                        }
                    }
                }
            }
                ...
                if (isset($media) && $media) {
                    ...
                    <div class="statbox widget box mt-3">
                        <div class="widget-content widget-content-area">
                            ...
                            <h4>Added <?php echo ucfirst($media_type) ?> Link</h4>
                            <div class="row">
...
//                                            $uploaded_media_html = '<a class="text-primary" href="' . base_url() . '' . DEFAULT_IMAGE_UPLOAD_PATH . '' . $template_media . '" target="_blank" id="template_uploaded_preview_holder_' . $temp_add_seq . '">' . $template_media_name . '</a>';
                ...
                if (isset($btn_url) && $btn_url) {
                    ...
                    <div class="statbox widget box mt-3">
                        <div class="widget-content widget-content-area">
                            <h4>Added Button URL Parameter</h4>
                            <div class="row">
                                <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                ...
                if (isset($media) && $media) {
                    ...
                    <div class="statbox widget box mt-3">
                        <div class="widget-content widget-content-area">
                            ...
                            <h4>Add <?php echo ucfirst($media_type) ?> URL</h4>
                            <div class="row">
...
//                                                    '</small>';
                ...
                if (isset($btn_url) && $btn_url) {
                    ...
                    <div class="statbox widget box mt-3">
                        <div class="widget-content widget-content-area">
                            <h4>Add Button URL Parameter</h4>
                            <div class="row">
                                <div class="col-xl-12 col-md-12 col-sm-12 col-12">
