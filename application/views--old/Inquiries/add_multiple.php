<div class="container">
    <div class="page-header">
        <div class="page-title">
            <h3>Inquiries - Add Multiple Inquiry</h3>
        </div>
    </div>
                ...
                <div class="widget-header">
                    <div class="row">
                        <div class="col-xl-9 col-md-9 col-sm-9 col-9">
                            <h4>Add Multiple Inquiry</h4>
                        </div>
                        <div class="col-xl-3 col-md-3 col-sm-3 col-3 text-right mt-2">
                            <button data-target="<?php echo base_url() . 'upload/excel_import_inquiries/add_inquiry_format.xlsx' ?>" target="_blank" class="btn-creative btn-3 btn-3d btn-c-gradient-1 flaticon-download-1 btn-inquiry-file-download"><span>Download Format</span></button>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-xl-6 col-md-6 col-sm-6 col-6">
                            <form method="post" enctype="multipart/form-data" action="<?php echo base_url() . 'inquiries/save_multiple' ?>" class="add_mutliple_inquiries" novalidate>
                                ...
                                <div class="form-group row mb-4">
                                    <label for="inquiries_file" class="col-xl-3 col-sm-4 col-sm-3 col-form-label">Upload File</label>
                                    <div class="col-xl-9 col-lg-8 col-sm-9">
