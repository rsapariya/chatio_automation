        ...
        if (!empty($this->input->post('file_name')) && !empty($user_id)) {
            ...
            try {
                ...
                if (!empty($rowsWithData)) {
                    ...
                    if (!empty($finalData)) {
                        $chunkArray = array_chunk($finalData, 50);
                        if(isset($chunkArray) && !empty($chunkArray)){
                            
                            foreach($chunkArray as $carray){
                                //pr($carray);
                                $inser_contacts = $this->db->insert_batch(tbl_clients, $carray);
                            }
                        }
