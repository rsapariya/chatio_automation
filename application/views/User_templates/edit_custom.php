                        ...
                        <div class="row">
                            <div class="col-lg-8 col-12">
                                <div class="form-group mb-4">
                                   ...
                                   <div class="form-check form-check-primary form-check-inline <?php echo $hide_type_class ?>">
                                        <input type="radio" id="hRadio1" name='custom_type' value='contacts' <?php echo isset($template_datas['custom_type']) && $template_datas['custom_type'] == 'contacts' ? 'checked="checked"' : '' ?> class="custom-control-input radio-classic-primary template-type-cls">
                                        <label class="form-check-label" for="hRadio1">
                                            VCard
                                        </label>
                                    </div>
                            ...
                            <div class="col-lg-8 col-12">
                                <div class="form-group mb-4">
                                    <label for="hName">Template Name</label>
                            ...
                            <?php
                            $class = '';
                            $contact_class = $action_class = 'hide';
                            $template_class = '';
                            ...
                            if (isset($template_datas['custom_type']) && $template_datas['custom_type'] == 'text') {
                                ...
                                $class = 'hide';
                                $action_class = '';
                            } else if (isset($template_datas['custom_type']) && $template_datas['custom_type'] == 'contacts') {
                                $class = $template_class= 'hide';
                                $contact_class = '';
                            }
                            ?>
                            ...
                            <div class="col-lg-8 col-12 div_contacts <?php echo $contact_class ?>">
                                <div class="col-lg-8 col-12">
                                    <div class="form-group mb-4">
                                        <label for="header_text">Contact Name</label>
                                        <input type="text" class="form-control" id="contact_name" name="contact_name" placeholder="" value="<?php echo isset($description['name']['formatted_name']) && !empty($description['name']['formatted_name']) ? $description['name']['formatted_name'] : '' ?>" required>
                                        <div class="valid-feedback"></div>
                                        <div class="invalid-feedback">Please fill the contact name</div>
                                    </div>
                                </div>
                                <?php if(isset($description['phone']) && !empty($description['phone'])){
                                    foreach($description['phone'] as $phone){ ?>
                                            <div class="col-lg-8 col-12">
                                                <div class="form-group mb-4">
                                                    <label for="header_text">Contact Number</label><br />
                                                    <input type="text" class="form-control vcard_contact_number" name="contact_number" placeholder="" value="<?php echo isset($description['contact_number']) ? $description['contact_number'] : '' ?>" required>
                                                    <div class="valid-feedback"></div>
