        ...
        <div class="col-lg-12 layout-spacing">
            <div class="statbox widget box box-shadow">
                <div class="widget-header">
                    <div class="row">
                        <div class="col-lg-6 col-12"><h4>User List</h4></div>    
                        <div class="col-lg-6 col-12 d-flex justify-content-end mt-3">
                            <button data-target="<?php echo base_url() ?>users/add" class="btn btn-primary mb-2 me-4 _effect--ripple waves-effect waves-light btn-add-user">
                ...
                <div class=" widget-content-area">
                    <div class="table-responsive pt-3">
                        <table id="users_dttble" class="table table-striped no-footer table-bordered">
                            <thead>
                                <tr>
