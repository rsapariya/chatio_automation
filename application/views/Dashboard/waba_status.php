    ...
    <div class="row layout-top-spacing">
        ...
        <div class="row layout-top-spacing">
            <div class="col-lg-12 layout-spacing">
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-12">
                                    <table class="table table-stripe">
                                        ...
                                        <tbody>
                                            <?php
                                            foreach ($message_details as $message_details) {
                ...
                <?php if (isset($conversion_cost) && !empty($conversion_cost)) { ?>
                    <div class="card mb-3">
                        <div class="card-body">
                            <h4 class="text-bold">WhatsApp Message Details With Cost</h4>
                            <div class="row">
                                <div class="col-lg-12 col-12">
                                    <table class="table table-stripe">
                                        <thead>
                                        ...
                                        <tbody>
                                            <?php
                                            usort($conversion_cost, function ($a, $b) {
                                                return $b['start'] <=> $a['start'];
                                            });

                                            foreach ($conversion_cost as $conversion_cost) {
                                                $startTimestamp = $conversion_cost['start'];
                                                $startDateTime = new DateTime("@$startTimestamp");
                                                $start = $startDateTime->format('d M Y H:i');
                                                $endTimestamp = $conversion_cost['end'];
                                                $endDateTime = new DateTime("@$endTimestamp");
                                                $end = $endDateTime->format('d M Y H:i');
                                                ?>
                                                <tr>
                                                    <td><?php echo $start; ?></td>
                                                    <td><?php echo $end; ?></td>
                                                    <td><?php echo isset($conversion_cost['conversation']) && !empty($conversion_cost['conversation']) ? $conversion_cost['conversation'] : '' ?></td>
                                                    <td><?php echo isset($conversion_cost['cost']) && !empty($conversion_cost['cost']) ? round($conversion_cost['cost'],2) : '' ?></td>
                                                </tr>
                                            <?php } ?>
                                        </tbody>
                                    </table>
