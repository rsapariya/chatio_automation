        ...
        <div class="col-lg-12 layout-spacing">
            <div class="statbox widget box box-shadow">
                <div class="widget-header">
                    <div class="row">
                        <div class="col-lg-6 col-12"><h4>Create Recampaign</h4></div>   
                    </div>
                </div> 
                <div class="widget-content widget-content-area">
                    <div class="row">
                        <div class="col-xl-5 col-md-6 col-sm-12 col-12">
                            <form method="post" id="create_recampaign_form">
                                <input type="hidden" id='campaign_id' name='campaign_id' value='<?php echo isset($campaign_id) ? $campaign_id : '' ?>'/>
                                <div class="row">
                                    <div class="col-12 mt-2" id="contact-counter"></div>
                                    <div class="col-12 mt-2">
                                        <div class="form-group">
                                            <label for="campaign_name">Recampaign For</label><br/>
                                            <div class="form-check form-check-primary form-check-inline">
                                                <input type="radio" id="read_only" name='recampaign_for' value='read_only' class="custom-control-input radio-classic-primary recampaign_for">
                                                <label class="form-check-label" for="read_only">
                                                    Who read
                                                </label>
                                            </div>
                                            <div class="form-check form-check-primary form-check-inline">
                                                <input type="radio" id="read_not_replied" name='recampaign_for' value='read_not_replied' class="custom-control-input radio-classic-primary recampaign_for">
                                                <label class="form-check-label" for="read_not_replied">
                                                    Who read but not replied
                                                </label>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12 mt-2">
                                        <button type="button" class="mt-4 mb-4 btn btn-primary" id="btn-create-recampaign">Create Campaign</button>
                                    </div>
                                </div>
                            </form>
                        </div>
