        ...
        <div class="col-lg-12 layout-spacing">
            <div class="statbox widget box box-shadow">
                <div class="widget-header">
                    <div class="row">
                        <div class="col-lg-6 col-12"><h4>Create Campaign</h4></div>   
                    </div>
                </div> 
                <div class="widget-content widget-content-area">
                    <div class="row">
                        <div class="col-xl-5 col-md-6 col-sm-12 col-12">
                            <form method="post" id="create_campaign_form">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 mt-2">
                                        <div class="form-group">
                                            <label for="campaing_tags">Tags</label>
                                            <input type="text" class="form-control" id="campaing_tags" name="group_ids" placeholder="Tags" value="">
                                                <?php if (isset($user_tags) && empty($user_tags)) { ?>
                                                    <small class="text-muted"> <i class="fa fa-info-circle"></i> Please add <a href="<?php echo base_url() ?>tag">Tags</a> first to assign</small>
                                                <?php } ?>     
                                        </div> 
                                    </div>
                                    <div class="col-12 mt-2">
                                    ...
                                    <div class="col-12 mt-2">
                                        <button type="button" class="mt-4 mb-4 btn btn-primary" id="btn-create-campaign">Create Campaign</button>
                                    </div>
                                </div>
                            </form>
                        </div>
                        <div class="col-xl-7 col-md-7 col-sm-12 col-12" id="contact_list">
