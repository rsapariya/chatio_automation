...
<html lang="en">
    <head>
        ...
        <link href="<?php echo DEFAULT_ADMIN_ASSET_PATH; ?>plugins/src/flatpickr/flatpickr.css" rel="stylesheet" type="text/css">
    ...
    <!--<link href="<?php //echo DEFAULT_ADMIN_ASSET_PATH   ?>plugins/src/table/datatable/custom_dt_custom.css" rel="stylesheet" type="text/css" />
    <link href="<?php //echo DEFAULT_ADMIN_ASSET_PATH   ?>plugins/src/table/datatable/dt-global_style.css" rel="stylesheet" type="text/css" />
    <link href="<?php // echo DEFAULT_ADMIN_ASSET_PATH   ?>plugins/src/table/datatable/custom_dt_miscellaneous.css" rel="stylesheet" type="text/css" >-->
        ...
        <link rel="stylesheet" href="<?php echo DEFAULT_ADMIN_ASSET_PATH ?>plugins/src/sweetalerts2/sweetalerts2.css">
        <link rel="stylesheet" href="<?php echo DEFAULT_ADMIN_ASSET_PATH; ?>plugins/src/emojionearea/emojionearea.min.css">
        <link rel="stylesheet" href="<?php echo DEFAULT_ADMIN_ASSET_PATH; ?>plugins/src/select2/select2.min.css">
        ...
        <link href="<?php echo DEFAULT_ADMIN_ASSET_PATH; ?>plugins/src/date_time_pickers/daterangepicker.css" rel="stylesheet" type="text/css">
        <link href="<?php echo DEFAULT_ADMIN_ASSET_PATH; ?>plugins/src/date_time_pickers/bootstrap-datetimepicker.min.css" rel="stylesheet" type="text/css">
        <link href="<?php echo DEFAULT_ADMIN_ASSET_PATH; ?>plugins/src/tagify/tagify.css" rel="stylesheet" type="text/css" >
        <link href="<?php echo DEFAULT_ADMIN_ASSET_PATH; ?>plugins/src/tomSelect/tom-select.default.min.css" rel="stylesheet" type="text/css" >
    ...
    <!--<script src="<?php //echo DEFAULT_ADMIN_ASSET_PATH   ?>plugins/src/table/datatable/datatables.js"></script>
    <script src="<?php //echo DEFAULT_ADMIN_ASSET_PATH   ?>plugins/src/table/datatable/button-ext/dataTables.buttons.min.js"></script>
    <script src="<?php //echo DEFAULT_ADMIN_ASSET_PATH   ?>plugins/src/table/datatable/button-ext/buttons.html5.min.js"></script>
    <script src="<?php //echo DEFAULT_ADMIN_ASSET_PATH   ?>plugins/src/table/datatable/button-ext/buttons.print.min.js"></script>
    <script src="<?php //echo DEFAULT_ADMIN_ASSET_PATH   ?>plugins/src/table/datatable/custom_miscellaneous.js"></script>-->
        <!-- END GLOBAL MANDATORY SCRIPTS -->

    <!--<script src="<?php echo DEFAULT_ADMIN_ASSET_PATH; ?>plugins/src/apex/apexcharts.min.js"></script>-->
        ...
        <script src="<?php echo DEFAULT_ADMIN_ASSET_PATH; ?>plugins/src/sweetalerts2/sweetalerts2.min.js"></script>
        ...
        <script src="<?php echo DEFAULT_ADMIN_JS_PATH; ?>apps/chat.js"></script>
        <script>
                ...
                <ul class="navbar-item theme-brand flex-row  text-center">
                    <li class="nav-item theme-logo-">
                        <!--<a href="<?php //echo base_url() . "dashboard"   ?>">
                            <img src="<?php //echo DEFAULT_ADMIN_IMAGE_PATH   ?>logo2.svg" class="navbar-logo" alt="logo">
                        </a>-->
                    </li>
                    <li class="nav-item theme-text">
                        <a href="<?php echo base_url() . "dashboard" ?>" class="nav-link"><span class="theme-text-color decorated-first-char">A</span>UTOMATION </a>
                    </li>
                </ul>
                        ...
                        <a href="javascript:void(0);" class="nav-link dropdown-toggle user" id="userProfileDropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <div class="avatar-container">
                                <div class="avatar avatar-sm avatar-indicators avatar-online">
                                    <img alt="avatar" src="<?php echo!empty($this->session->userdata('wa_profile_image_url')) ? $this->session->userdata('wa_profile_image_url') : DEFAULT_ADMIN_IMAGE_PATH . 'profile-30.png' ?>" class="rounded-circle">
                                </div>
                            </div>
                        </a>
                        ...
                        <div class="dropdown-menu position-absolute" aria-labelledby="userProfileDropdown">
                            ...
                            <div class="dropdown-item">
                                <a href="<?php echo base_url() ?>settings">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-settings"><circle cx="12" cy="12" r="3"></circle><path d="M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 0 1 0 2.83 2 2 0 0 1-2.83 0l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 0 1-2 2 2 2 0 0 1-2-2v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 0 1-2.83 0 2 2 0 0 1 0-2.83l.06-.06a1.65 1.65 0 0 0 .33-1.82 1.65 1.65 0 0 0-1.51-1H3a2 2 0 0 1-2-2 2 2 0 0 1 2-2h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 0 1 0-2.83 2 2 0 0 1 2.83 0l.06.06a1.65 1.65 0 0 0 1.82.33H9a1.65 1.65 0 0 0 1-1.51V3a2 2 0 0 1 2-2 2 2 0 0 1 2 2v.09a1.65 1.65 0 0 0 1 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 0 1 2.83 0 2 2 0 0 1 0 2.83l-.06.06a1.65 1.65 0 0 0-.33 1.82V9a1.65 1.65 0 0 0 1.51 1H21a2 2 0 0 1 2 2 2 2 0 0 1-2 2h-.09a1.65 1.65 0 0 0-1.51 1z"></path></svg>  <span>API Settings</span>
                                </a>
                            </div>
                            <div class="dropdown-item">
                ...
                <nav id="sidebar">
                    ...
                    <div class="navbar-nav theme-brand flex-row  text-center">
                        <div class="nav-logo">
                            <!--<div class="nav-item theme-logo-">
                                <a href="<?php //echo base_url();   ?>dashboard">
                                    <img src="<?php //echo DEFAULT_ADMIN_IMAGE_PATH   ?>logo.svg" class="navbar-logo" alt="logo">
                                </a>
                            </div>-->
                    ...
                    <ul class="list-unstyled menu-categories" id="accordionExample">
                        ...
                        <?php } elseif (isset($user_data) && $user_data['type'] == 'user' && !empty($user_data['waba_access'])) { ?>
                            ...
                            <li class="menu <?php echo ($controller == 'clients') || ($controller == 'tag') ? 'active' : ''; ?>">
                                ...
                                <ul class="dropdown-menu submenu list-unstyled" id="client-menu" data-bs-parent="#accordionExample">
                                    <li>
                        ...
                        if (isset($user_data) && $user_data['type'] == 'user') {
                            ...
                            if (!empty($user_data['waba_access'])) {
                                ...
                                <li class="menu <?php echo ($controller == 'automations') ? 'active' : ''; ?>">
                                    <a href="<?php echo base_url(); ?>automations" class="dropdown-toggle">
                                        <div class="">
                                ...
                                <!--<li class="menu <?php //echo ($controller == 'inquiries') ? 'active' : '';   ?>">
                                    <a href="<?php //echo base_url();   ?>inquiries" class="dropdown-toggle">
                                        <div class="">
    ...
    <?php if (isset($user_data) && !empty($user_data['waba_access']) && !empty($user_data['crm_lead_access'])) { ?>
                                <li class="menu <?php echo ($controller == 'indiamart_leads') ? 'active' : ''; ?>">
                                    ...
                                    <ul class="dropdown-menu submenu list-unstyled" id="crmlead-menu" data-bs-parent="#accordionExample">
                                        <li>
    ...
    <?php } elseif (isset($user_data) && !empty($user_data['crm_lead_access'])) { ?>
                            ...
                            if (!empty($user_data['waba_access'])) {
                                ...
                                <li class="menu <?php echo ($controller == 'replyResponse' || $controller == 'ChatLogs') ? 'active' : ''; ?>">
                                    ...
                                    <ul class="dropdown-menu submenu list-unstyled" id="chatlog-menu" data-bs-parent="#accordionExample">
                                        <li>
...
<?php echo $body ?>
                        <div class="modal fade" id="modal_view_template" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
