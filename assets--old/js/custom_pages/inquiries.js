    ...
    columns: [
        ...
        },
        {
            ...
            render: function (data, type, full, meta) {
                ...
                action += '<li><a href="' + base_url + 'inquiries/edit/' + btoa(full.id) + '" class="bs-tooltip" data-toggle="tooltip" data-placement="top" data-original-title="Edit" title=""><i class="flaticon-edit p-1 br-6 mb-1"></i></a></li>';
                action += '<li><a href="javascript:void(0)" onclick="delete_inquiry(' + full.id + ')"  title="" class="bs-tooltip" data-toggle="tooltip" data-placement="top" data-original-title="Delete"><i class="flaticon-delete p-1 br-6 mb-1"></i></a></li>';
                action += '</ul></td>';
                return action;
            }
        }
